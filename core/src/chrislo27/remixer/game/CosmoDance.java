...
public class CosmoDance extends Game {

	public CosmoDance(String name, String contributors) {
		...
		this.patterns.put("dancers - turn right", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(1 + 1 / 6f, "spaceDance_right1"));
			}
		...
		this.patterns.put("dancers - let's sit down", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(2 / 3f, "spaceDance_sit1"));
		...
		this.patterns.put("dancers - pa-pa-pa punch!", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(2 / 3f, "spaceDance_pa1"));
				array.add(new SoundEffect(1, "spaceDance_pa1"));

				array.add(new SoundEffect(1f + 2 / 3f, "spaceDance_punch1"));
			}
		...
		this.patterns.put("gramps - turn right", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(1 + 1 / 6f, "spaceDance_right2"));
			}
		...
		this.patterns.put("gramps - let's sit down", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(2 / 3f, "spaceDance_sit2"));
		...
		this.patterns.put("gramps - pa-pa-pa punch!", new Pattern(this) {
			...
			public void addPatternToArray(Array<SoundEffect> array) {
				...
				array.add(new SoundEffect(2 / 3f, "spaceDance_pa2"));
				array.add(new SoundEffect(1, "spaceDance_pa2"));

				array.add(new SoundEffect(1f + 2 / 3f, "spaceDance_punch2"));
			}
